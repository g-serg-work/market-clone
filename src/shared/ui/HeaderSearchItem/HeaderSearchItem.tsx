...
import cls from './HeaderSearchItem.module.scss';
...
export const HeaderSearchItem = memo((props: HeaderSearchItemProps) => {
    ...
    return (
        <div className={classNames(cls.HeaderSearchItem, {}, [className])}>
            <div
